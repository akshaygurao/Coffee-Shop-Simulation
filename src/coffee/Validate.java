...
public class Validate {
	 ...
	 */
	//@Invariants: machine capacity, no of cooks, no of tables
	//Precondition: the simulated conditions are input as list
	//Postcondition: returns if the simulation was successful or unsuccessful
	//Exception: if either of the condition is violated interrupt
