...
public class Simulation {
	...
	public static LinkedList<Integer> tableList;
	public static LinkedQueue<Order> orderList;
	...
	//@Invariance: the machine capacity, the number of cooks, the number of tables
	//Preconditions: check the number of tables empty, no of free slots in machine
	//Postconditions: complete the customer order and mark table as empty when customer leaves
	//Exception: when interrupt method is called the simultaion stops
